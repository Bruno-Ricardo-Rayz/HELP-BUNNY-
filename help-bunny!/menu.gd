...
# --- LISTA DE VÍDEOS ---
# Adicione o caminho de todos os seus vídeos na lista abaixo:
...
func _ready():
	# Conecta o sinal de tempo do Timer via código
...
func trocar_video_com_fade():
	# 1. ESCURECE A TELA (Fade Out de 1.5 segundos)
	...
	# 3. CLAREIA A TELA (Fade In de 1.5 segundos)
